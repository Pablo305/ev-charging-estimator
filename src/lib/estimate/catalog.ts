...
// Updated with real pricing from 141 proposals knowledge base
// ============================================================
...
export const PRICEBOOK: readonly PricebookItem[] = [
  ...
  },
  {
    ...
    catalogPrice: null,
    unit: 'EA',
    notes: 'Use chargepoint-pricing.ts getChargePointPrice() for component pricing',
    status: 'blank',
  },
  {
  ...
  },
  {
    ...
    catalogPrice: 3130,
    unit: 'EA',
    notes: 'See chargepoint-pricing.ts for full component breakdown (~$5,461 total with cloud/assure)',
    status: 'priced',
  },
  {
  ...
  },
  {
    ...
    category: 'CHARGER',
    description: 'ChargePoint CT4013 - Pedestal-mounted, single port, 18\' cable',
    catalogPrice: null,
    unit: 'EA',
    notes: 'Use chargepoint-pricing.ts getChargePointPrice() — total ~$5,846',
    status: 'blank',
  },
  {
  ...
  {
    id: 'charger-cp-ct4021-ped-dual-18',
    category: 'CHARGER',
    description: 'ChargePoint CT4021 - Dual Pedestal, 18\' cable',
    catalogPrice: null,
    unit: 'EA',
    notes: 'Use chargepoint-pricing.ts getChargePointPrice() — total ~$8,251',
    status: 'blank',
  },
  {
    id: 'charger-cp-ct4025-ped-dual-23',
    category: 'CHARGER',
    description: 'ChargePoint CT4025 - Dual Pedestal, 23\' cable',
    catalogPrice: null,
    unit: 'EA',
    notes: 'Use chargepoint-pricing.ts getChargePointPrice() — total ~$8,920',
    status: 'blank',
  },
  {
    id: 'charger-cp-cp6021b-50a',
    category: 'CHARGER',
    description: 'ChargePoint CP6021B-50A',
    catalogPrice: null,
    unit: 'EA',
    notes: 'Use chargepoint-pricing.ts getChargePointPrice() for component pricing',
    status: 'blank',
  ...
  {
    id: 'charger-cp-cp6621b-80a-dual-23',
    category: 'CHARGER',
    description: 'ChargePoint CP6621B-80A - Dual, 23\' cable',
    catalogPrice: null,
    unit: 'EA',
    notes: 'Use chargepoint-pricing.ts getChargePointPrice() — total ~$10,852',
    status: 'blank',
  },
  {
    id: 'charger-cp-cp6021b-80a-dual-18',
    category: 'CHARGER',
    description: 'ChargePoint CP6021B-80A - Dual, 18\' cable',
    catalogPrice: null,
    unit: 'EA',
    notes: 'Use chargepoint-pricing.ts getChargePointPrice() — total ~$11,397',
    status: 'blank',
  },
  {
  ...
  // ── CIVIL ────────────────────────────────────────────────────
  {
    ...
    catalogPrice: 85,
    unit: 'LF',
    notes: 'From 141-proposal knowledge base',
    status: 'priced',
  },
  {
  ...
  {
    id: 'civil-asphalt-removal',
    category: 'CIVIL',
    description: 'Asphalt Removal',
    catalogPrice: 8.50,
    unit: 'SF',
    notes: 'Split from former "Remove Asphalt Or Concrete" TBD item',
    status: 'priced',
  },
  {
    id: 'civil-asphalt-restore',
    category: 'CIVIL',
    description: 'Asphalt Restoration',
    catalogPrice: 33,
    unit: 'SF',
    notes: 'From 141-proposal knowledge base',
    status: 'priced',
  ...
  {
    id: 'civil-curb-gutter',
    category: 'CIVIL',
    description: 'Concrete Curb & Gutter 6"x24"',
    catalogPrice: 80,
    unit: 'LF',
    notes: 'From 141-proposal knowledge base',
    status: 'priced',
  ...
  {
    id: 'civil-header-curb',
    category: 'CIVIL',
    description: 'Concrete Header Curb 6"',
    catalogPrice: 50,
    unit: 'LF',
    notes: 'From 141-proposal knowledge base',
    status: 'priced',
  ...
  {
    id: 'civil-curb-removal',
    category: 'CIVIL',
    description: 'Curb Removal',
    catalogPrice: 24,
    unit: 'LF',
    notes: 'From 141-proposal knowledge base',
    status: 'priced',
  ...
  },
  {
    id: 'civil-scan-xray',
    category: 'CIVIL',
    description: 'Scan/X-ray Wall/Floor',
    catalogPrice: 600,
    unit: 'EA',
    notes: 'From 141-proposal knowledge base',
    status: 'priced',
  },
  {
    id: 'civil-encasement',
    category: 'CIVIL',
    description: 'Encasement of Conduits',
    catalogPrice: 450,
    unit: 'CY',
    notes: 'From 141-proposal knowledge base',
    status: 'priced',
  ...
  {
    id: 'civil-road-plates',
    category: 'CIVIL',
    description: 'Road Plates',
    catalogPrice: 48,
    unit: 'LF',
    notes: 'From 141-proposal knowledge base',
    status: 'priced',
  },
  {
    id: 'civil-cast-curb',
    category: 'CIVIL',
    description: 'Cast-in-Place Integrated Curb/Post',
    catalogPrice: 475,
    unit: 'CY',
    notes: 'From 141-proposal knowledge base',
    status: 'priced',
  ...
  {
    id: 'civil-cast-foundation',
    category: 'CIVIL',
    description: 'Cast-in-Place Post Foundations',
    catalogPrice: 850,
    unit: 'EA',
    notes: 'From 141-proposal knowledge base',
    status: 'priced',
  },
  {
    id: 'civil-cast-trash',
    category: 'CIVIL',
    description: 'Cast-in-Place Trash/Recycle Bins',
    catalogPrice: 500,
    unit: 'EA',
    notes: 'From 141-proposal knowledge base',
    status: 'priced',
  ...
  {
    id: 'civil-unforeseen-rock',
    category: 'CIVIL',
    description: 'Unforeseen Rock & Masonry Removal',
    catalogPrice: 325,
    unit: 'CY',
    notes: 'From 141-proposal knowledge base',
    status: 'priced',
  ...
  {
    id: 'deseng-property-stake',
    category: 'DES/ENG',
    description: 'Property Line Stake/Garage Field Sketch',
    catalogPrice: 1500,
    unit: 'LS',
    notes: 'From 141-proposal knowledge base',
    status: 'priced',
  ...
  {
    id: 'deseng-permit-coord',
    category: 'DES/ENG',
    description: 'Permit Coordination & Filing (2 visits)',
    catalogPrice: 950,
    unit: 'EA',
    notes: 'From 141-proposal knowledge base',
    status: 'priced',
  ...
  // ── ELEC ─────────────────────────────────────────────────────
  {
    ...
    catalogPrice: 25000,
    unit: 'EA',
    notes: 'Range $15K-$40K depending on capacity. Always requires manual review.',
    status: 'priced',
    manualReview: true,
    manualReviewReason: 'Transformer pricing varies $15K-$40K based on capacity, utility requirements, and site conditions',
  },
  ...
  {
    id: 'eleclbrmat-pvc-conduit',
    category: 'ELEC LBR MAT',
    description: 'PVC Schedule 40 up to 2" with #4 Conductors',
    catalogPrice: 20,
    unit: 'LF',
    notes: 'From 141-proposal knowledge base',
    status: 'priced',
  ...
  {
    id: 'eleclbrmat-emt-125',
    category: 'ELEC LBR MAT',
    description: 'EMT Conduit 1-1/4"',
    catalogPrice: 18,
    unit: 'LF',
    notes: 'From 141-proposal knowledge base',
    status: 'priced',
  ...
  {
    id: 'eleclbrmat-conductors',
    category: 'ELEC LBR MAT',
    description: 'Installation of Conductors up to #4',
    catalogPrice: 30,
    unit: 'LF',
    notes: 'From 141-proposal knowledge base',
    status: 'priced',
  ...
  // ── MISC ─────────────────────────────────────────────────────
  {
    ...
    catalogPrice: 10,
    unit: 'MI',
    notes: 'Per mile for out-of-area travel',
    status: 'priced',
  },
  {
    id: 'misc-geographic-travel',
    category: 'MISC',
    description: 'Out of Geographic Range per Mile (after 60 each way)',
    catalogPrice: 10,
    unit: 'MI',
    notes: 'From 141-proposal knowledge base. Applied after 60 miles each way.',
    status: 'priced',
  },
  ...
  {
    id: 'network-wifi-install',
    category: 'NETWORK',
    description: 'Install Owner-Provided WiFi Equipment',
    catalogPrice: 450,
    unit: 'EA',
    notes: 'From 141-proposal knowledge base',
    status: 'priced',
  },
  {
    ...
    category: 'NETWORK',
    description: 'Install Owner-Provided Connectivity Extender',
    catalogPrice: 450,
    unit: 'EA',
    notes: 'From 141-proposal knowledge base',
    status: 'priced',
  ...
  // ── SITE WORK ────────────────────────────────────────────────
  {
    ...
    catalogPrice: 400,
    unit: 'EA',
    notes: 'Per Parking Spot. From 35 proposals: consistent $400/ea for signage + stencils.',
    status: 'priced',
  },
  {
  ...
  },
  {
    id: 'site-lighting',
    category: 'SITE WORK',
    description: 'Install Lighting & Foundation (owner furnished)',
    catalogPrice: 2200,
    unit: 'EA',
    notes: 'From 141-proposal knowledge base',
    status: 'priced',
  },
  {
    id: 'site-striping',
    category: 'SITE WORK',
    description: 'Install Striping per Stall',
    catalogPrice: 220,
    unit: 'EA',
    notes: 'From 141-proposal knowledge base',
    status: 'priced',
  ...
  {
    id: 'site-signage-stencils',
    category: 'SITE WORK',
    description: 'Install Signage and Stencils',
    catalogPrice: 400,
    unit: 'EA',
    notes: 'From 141-proposal knowledge base',
    status: 'priced',
  ...
  {
    id: 'site-concrete-wheelstop',
    category: 'SITE WORK',
    description: 'Concrete Wheelstops',
    catalogPrice: 350,
    unit: 'EA',
    notes: 'From 141-proposal knowledge base',
    status: 'priced',
  ...
  {
    id: 'site-rubber-wheelstop',
    category: 'SITE WORK',
    description: 'Furnish & Install Rubber Wheelstops',
    catalogPrice: 275,
    unit: 'EA',
    notes: 'From 141-proposal knowledge base',
    status: 'priced',
...
// Observed from real estimates vs pricebook (141 proposals)

export const KNOWN_OVERRIDES: Record<string, { catalogPrice: number; typicalOverride: number; reason: string }> = {
  'eleclbrmat-conduit-wire': { catalogPrice: 32, typicalOverride: 36, reason: 'Per-project complexity adjustment — complex routing' },
  'civil-coring-slab-scan': { catalogPrice: 312, typicalOverride: 950, reason: 'Site-specific conditions; catalog price may be base only — difficult access' },
  'deseng-stamped-plans': { catalogPrice: 3500, typicalOverride: 4250, reason: 'Complex permit jurisdictions' },
  'deseng-load-calc': { catalogPrice: 900, typicalOverride: 1050, reason: 'Per-project complexity adjustment — complex projects' },
};
