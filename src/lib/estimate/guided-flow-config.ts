...
export const CONDITIONAL_FIELDS: Record<InstallationType, ConditionalField[]> = {
  ...
  full_turnkey_garage: [
    ...
    },
    {
      ...
      hint: 'Auto-calculated when you place chargers and panel on the map. Override here if needed.',
      mapDerived: true,
    },
    {
      id: 'numBollards',
  ...
  full_turnkey_lot: [
    ...
    },
    {
      ...
      min: 0,
      placeholder: '0',
      hint: 'Feet of concrete to cut or break. Enter 0 if route is all dirt/grass.',
      mapDerived: true,
    },
    {
    ...
    },
    {
      ...
      min: 0,
      placeholder: 'Auto from map',
      hint: 'Auto-set to charger count from map. Override if needed.',
      mapDerived: true,
    },
    {
      id: 'coreDrilling',
    ...
    },
    {
      ...
      min: 0,
      placeholder: 'Auto from map',
      hint: 'Auto-calculated from panel to charger distance. Override if needed.',
      mapDerived: true,
    },
    {
      id: 'pvcConduitLength',
